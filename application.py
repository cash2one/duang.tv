...
define("mysql_database", default = "duang", help = "community database name")
define("mysql_user", default = "duang", help = "community database user")
define("mysql_password", default = "duang", help = "community database password")
